...
/* ═══════════════════ 데이터 ═══════════════════ */
const CANDS = [
  { id:"ronaldo",       name:"Cristiano Ronaldo",  group:"Al Nassr",           nat:"🇵🇹 Portugal",    cat:"Sports",    color:"#dc2626", v:15200000 },
  { id:"messi",         name:"Lionel Messi",       group:"Inter Miami",        nat:"🇦🇷 Argentina",   cat:"Sports",    color:"#2563eb", v:13100000 },
  { id:"mrbeast",       name:"MrBeast",            group:"YouTube",            nat:"🇺🇸 USA",         cat:"Creator",   color:"#16a34a", v:12400000 },
  { id:"taylor",        name:"Taylor Swift",       group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#a855f7", v:11200000 },
  { id:"lisa_bp",       name:"LISA",               group:"BLACKPINK",          nat:"🇹🇭 Thailand",    cat:"K-Pop",     color:"#f472b6", v:10100000 },
  { id:"jungkook",      name:"Jungkook",           group:"BTS",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#6366f1", v:9400000  },
  { id:"ishowspeed",    name:"IShowSpeed",         group:"YouTube",            nat:"🇺🇸 USA",         cat:"Creator",   color:"#ef4444", v:9200000  },
  { id:"v_bts",         name:"V (Taehyung)",       group:"BTS",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#8b5cf6", v:9100000  },
  { id:"jimin_bts",     name:"Jimin",              group:"BTS",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#a78bfa", v:8900000  },
  { id:"im_youngwoong", name:"Im Young-woong",     group:"Solo",               nat:"🇰🇷 Korea",       cat:"Trot",      color:"#3b82f6", v:8600000  },
  { id:"jennie_bp",     name:"Jennie",             group:"BLACKPINK",          nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#ec4899", v:8500000  },
  { id:"kylian",        name:"Kylian Mbappé",      group:"Real Madrid",        nat:"🇫🇷 France",      cat:"Sports",    color:"#1d4ed8", v:8300000  },
  { id:"beyonce",       name:"Beyoncé",            group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#fbbf24", v:8100000  },
  { id:"billie",        name:"Billie Eilish",      group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#4ade80", v:7400000  },
  { id:"elon_musk",     name:"Elon Musk",          group:"X / Tesla / SpaceX", nat:"🇺🇸 USA",         cat:"CEO",       color:"#64748b", v:7800000  },
  { id:"virat",         name:"Virat Kohli",        group:"India Cricket",      nat:"🇮🇳 India",       cat:"Sports",    color:"#166534", v:7900000  },
  { id:"rose_bp",       name:"Rosé",               group:"BLACKPINK",          nat:"🇦🇺 Australia",   cat:"K-Pop",     color:"#fb7185", v:7800000  },
  { id:"jisoo_bp",      name:"Jisoo",              group:"BLACKPINK",          nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#e11d48", v:7300000  },
  { id:"ariana",        name:"Ariana Grande",      group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#c084fc", v:7000000  },
  { id:"neymar",        name:"Neymar Jr.",         group:"Al Hilal",           nat:"🇧🇷 Brazil",      cat:"Sports",    color:"#16a34a", v:6900000  },
  { id:"shahrukh",      name:"Shah Rukh Khan",     group:"Bollywood",          nat:"🇮🇳 India",       cat:"Actor",     color:"#dc2626", v:6800000  },
  { id:"son_heungmin",  name:"Son Heung-min",      group:"Tottenham",          nat:"🇰🇷 Korea",       cat:"Sports",    color:"#60a5fa", v:6300000  },
  { id:"suga_bts",      name:"Suga / Agust D",     group:"BTS",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#7c3aed", v:6300000  },
  { id:"bad_bunny",     name:"Bad Bunny",          group:"Solo",               nat:"🇵🇷 Puerto Rico", cat:"Reggaeton", color:"#65a30d", v:6200000  },
  { id:"selena",        name:"Selena Gomez",       group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#f9a8d4", v:6100000  },
  { id:"kylie",         name:"Kylie Jenner",       group:"Influencer",         nat:"🇺🇸 USA",         cat:"Influencer",color:"#be185d", v:6000000  },
  { id:"jhope_bts",     name:"J-Hope",             group:"BTS",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#f59e0b", v:6000000  },
  { id:"zendaya",       name:"Zendaya",            group:"Actor",              nat:"🇺🇸 USA",         cat:"Actor",     color:"#f59e0b", v:6400000  },
  { id:"haaland",       name:"Erling Haaland",     group:"Man City",           nat:"🇳🇴 Norway",      cat:"Sports",    color:"#15803d", v:5500000  },
  { id:"harry_styles",  name:"Harry Styles",       group:"Solo",               nat:"🇬🇧 UK",          cat:"Pop",       color:"#22d3ee", v:5600000  },
  { id:"pewdiepie",     name:"PewDiePie",          group:"YouTube",            nat:"🇸🇪 Sweden",      cat:"Creator",   color:"#7c3aed", v:5700000  },
  { id:"wonyoung_ive",  name:"Wonyoung",           group:"IVE",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#f43f5e", v:5700000  },
  { id:"iu_solo",       name:"IU",                 group:"Solo",               nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#38bdf8", v:5400000  },
  { id:"rm_bts",        name:"RM",                 group:"BTS",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#10b981", v:5400000  },
  { id:"ksi",           name:"KSI",                group:"YouTube",            nat:"🇬🇧 UK",          cat:"Creator",   color:"#92400e", v:5300000  },
  { id:"felix_skz",     name:"Felix",              group:"Stray Kids",         nat:"🇦🇺 Australia",   cat:"K-Pop",     color:"#f59e0b", v:5300000  },
  { id:"weeknd",        name:"The Weeknd",         group:"Solo",               nat:"🇨🇦 Canada",      cat:"Pop",       color:"#9f1239", v:5300000  },
  { id:"dwayne",        name:"Dwayne Johnson",     group:"Actor",              nat:"🇺🇸 USA",         cat:"Actor",     color:"#78716c", v:5800000  },
  { id:"dhoni",         name:"MS Dhoni",           group:"India Cricket",      nat:"🇮🇳 India",       cat:"Sports",    color:"#fbbf24", v:5800000  },
  { id:"gdragon",       name:"G-Dragon",           group:"BIGBANG",            nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#eab308", v:5200000  },
  { id:"jin_bts",       name:"Jin",                group:"BTS",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#06b6d4", v:5200000  },
  { id:"ed_sheeran",    name:"Ed Sheeran",         group:"Solo",               nat:"🇬🇧 UK",          cat:"Pop",       color:"#f97316", v:5200000  },
  { id:"khaby",         name:"Khaby Lame",         group:"TikTok #1",          nat:"🇮🇹 Italy",       cat:"Influencer",color:"#78716c", v:5100000  },
  { id:"hyunjin_skz",   name:"Hyunjin",            group:"Stray Kids",         nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#fbbf24", v:5000000  },
  { id:"sabrina",       name:"Sabrina Carpenter",  group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#fde047", v:5000000  },
  { id:"justin_bieber", name:"Justin Bieber",      group:"Solo",               nat:"🇨🇦 Canada",      cat:"Pop",       color:"#2563eb", v:5000000  },
  { id:"conor",         name:"Conor McGregor",     group:"UFC",                nat:"🇮🇪 Ireland",     cat:"Sports",    color:"#b45309", v:4900000  },
  { id:"jay_chou",      name:"Jay Chou",           group:"Solo",               nat:"🇹🇼 Taiwan",      cat:"C-Pop",     color:"#1e40af", v:4900000  },
  { id:"dua_lipa",      name:"Dua Lipa",           group:"Solo",               nat:"🇬🇧 UK",          cat:"Pop",       color:"#60a5fa", v:4500000  },
  { id:"kendall",       name:"Kendall Jenner",     group:"Model",              nat:"🇺🇸 USA",         cat:"Influencer",color:"#a8a29e", v:4500000  },
  { id:"timothee",      name:"Timothée Chalamet",  group:"Actor",              nat:"🇫🇷 France",      cat:"Actor",     color:"#1d4ed8", v:5500000  },
  { id:"drake",         name:"Drake",              group:"Solo",               nat:"🇨🇦 Canada",      cat:"Hip-Hop",   color:"#1d4ed8", v:4800000  },
  { id:"karina_aespa",  name:"Karina",             group:"aespa",              nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#14b8a6", v:4700000  },
  { id:"stephen_curry", name:"Stephen Curry",      group:"Golden State",       nat:"🇺🇸 USA",         cat:"Sports",    color:"#fbbf24", v:4700000  },
  { id:"priyanka",      name:"Priyanka Chopra",    group:"Actor",              nat:"🇮🇳 India",       cat:"Actor",     color:"#be185d", v:4700000  },
  { id:"olivia",        name:"Olivia Rodrigo",     group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#c026d3", v:4700000  },
  { id:"mo_salah",      name:"Mohamed Salah",      group:"Liverpool",          nat:"🇪🇬 Egypt",       cat:"Sports",    color:"#dc2626", v:4600000  },
  { id:"adele",         name:"Adele",              group:"Solo",               nat:"🇬🇧 UK",          cat:"Pop",       color:"#1e3a5f", v:4600000  },
  { id:"lady_gaga",     name:"Lady Gaga",          group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#818cf8", v:4300000  },
  { id:"kai_cenat",     name:"Kai Cenat",          group:"Twitch",             nat:"🇺🇸 USA",         cat:"Creator",   color:"#a855f7", v:4200000  },
  { id:"kendrick",      name:"Kendrick Lamar",     group:"Solo",               nat:"🇺🇸 USA",         cat:"Hip-Hop",   color:"#b45309", v:4200000  },
  { id:"travis_scott",  name:"Travis Scott",       group:"Solo",               nat:"🇺🇸 USA",         cat:"Hip-Hop",   color:"#44403c", v:4300000  },
  { id:"charli",        name:"Charli D'Amelio",    group:"TikTok",             nat:"🇺🇸 USA",         cat:"Influencer",color:"#f9a8d4", v:4400000  },
  { id:"shakira",       name:"Shakira",            group:"Solo",               nat:"🇨🇴 Colombia",    cat:"Pop",       color:"#fbbf24", v:4400000  },
  { id:"kai_exo",       name:"Kai",                group:"EXO",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#f97316", v:4000000  },
  { id:"sza",           name:"SZA",                group:"Solo",               nat:"🇺🇸 USA",         cat:"R&B",       color:"#7c3aed", v:4000000  },
  { id:"lana",          name:"Lana Del Rey",       group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#4338ca", v:4000000  },
  { id:"doja_cat",      name:"Doja Cat",           group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#be185d", v:3800000  },
  { id:"winter_aespa",  name:"Winter",             group:"aespa",              nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#06b6d4", v:4100000  },
  { id:"bangchan_skz",  name:"Bang Chan",          group:"Stray Kids",         nat:"🇦🇺 Australia",   cat:"K-Pop",     color:"#d97706", v:4400000  },
  { id:"roger_federer", name:"Roger Federer",      group:"Tennis",             nat:"🇨🇭 Switzerland", cat:"Sports",    color:"#b91c1c", v:4100000  },
  { id:"baekhyun_exo",  name:"Baekhyun",           group:"EXO",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#ea580c", v:3700000  },
  { id:"tzuyu_twice",   name:"Tzuyu",              group:"TWICE",              nat:"🇹🇼 Taiwan",      cat:"K-Pop",     color:"#fbcfe8", v:3600000  },
  { id:"yujin_ive",     name:"Yujin",              group:"IVE",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#fb923c", v:3900000  },
  { id:"minji_nj",      name:"Minji",              group:"NewJeans",           nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#84cc16", v:3900000  },
  { id:"hanni_nj",      name:"Hanni",              group:"NewJeans",           nat:"🇦🇺 Australia",   cat:"K-Pop",     color:"#4ade80", v:3800000  },
  { id:"yeonjun_txt",   name:"Yeonjun",            group:"TXT",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#c084fc", v:3800000  },
  { id:"taeyong_nct",   name:"Taeyong",            group:"NCT",                nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#0ea5e9", v:3400000  },
  { id:"wonwoo_svt",    name:"Wonwoo",             group:"SEVENTEEN",          nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#10b981", v:3200000  },
  { id:"nayeon_twice",  name:"Nayeon",             group:"TWICE",              nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#f9a8d4", v:3300000  },
  { id:"kenshi_yonezu", name:"Kenshi Yonezu",      group:"Solo",               nat:"🇯🇵 Japan",       cat:"J-Pop",     color:"#1d4ed8", v:3200000  },
  { id:"hongjoong",     name:"Hongjoong",          group:"ATEEZ",              nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#dc2626", v:3000000  },
  { id:"markiplier",    name:"Markiplier",         group:"YouTube",            nat:"🇺🇸 USA",         cat:"Creator",   color:"#ef4444", v:3900000  },
  { id:"miley",         name:"Miley Cyrus",        group:"Solo",               nat:"🇺🇸 USA",         cat:"Pop",       color:"#f59e0b", v:3800000  },
  { id:"bella_poarch",  name:"Bella Poarch",       group:"TikTok",             nat:"🇵🇭 Philippines", cat:"Influencer",color:"#818cf8", v:3500000  },
  { id:"taemin",        name:"Taemin",             group:"SHINee",             nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#818cf8", v:2900000  },
  { id:"yoasobi",       name:"YOASOBI",            group:"Duo",                nat:"🇯🇵 Japan",       cat:"J-Pop",     color:"#818cf8", v:2900000  },
  { id:"ado_jp",        name:"Ado",                group:"Solo",               nat:"🇯🇵 Japan",       cat:"J-Pop",     color:"#4f46e5", v:2700000  },
  { id:"soyeon_gidle",  name:"Soyeon",             group:"(G)I-DLE",           nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#d946ef", v:2800000  },
  { id:"ryujin_itzy",   name:"Ryujin",             group:"ITZY",               nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#eab308", v:2900000  },
  { id:"heeseung_enhy", name:"Heeseung",           group:"ENHYPEN",            nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#8b5cf6", v:2600000  },
  { id:"wonbin_riize",  name:"Wonbin",             group:"RIIZE",              nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#818cf8", v:2600000  },
  { id:"kazuha_lsrfm",  name:"Kazuha",             group:"LE SSERAFIM",        nat:"🇯🇵 Japan",       cat:"K-Pop",     color:"#fde68a", v:2500000  },
  { id:"irene_rv",      name:"Irene",              group:"Red Velvet",         nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#dc2626", v:2700000  },
  { id:"youngtak",      name:"Youngtak",           group:"Solo",               nat:"🇰🇷 Korea",       cat:"Trot",      color:"#0891b2", v:2100000  },
  { id:"lee_chanwon",   name:"Lee Chan-won",       group:"Solo",               nat:"🇰🇷 Korea",       cat:"Trot",      color:"#0369a1", v:1900000  },
  { id:"hanbin_zb1",    name:"Kim Hanbin",         group:"ZEROBASEONE",        nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#60a5fa", v:2300000  },
  { id:"minju_illit",   name:"Minju",              group:"ILLIT",              nat:"🇰🇷 Korea",       cat:"K-Pop",     color:"#fbcfe8", v:1700000  },
  { id:"gem_deng",      name:"G.E.M.",             group:"Solo",               nat:"🇨🇳 China",       cat:"C-Pop",     color:"#7c3aed", v:2700000  },
];
